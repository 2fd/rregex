...
export const r_regex_to_string = { test: () => {
	deepEqual(new RRegex('a').toString(), 'a');
}}

export const r_regex_is_match = { test: () => {
...
export const r_regex_is_match_at = { test: () => {
	const regex = new RRegex('a');
...
export const r_regex_find = { test: () => {
	const regex = new RRegex('a');
...
export const r_regex_find_at = { test: () => {
	const regex = new RRegex('a');
	deepEqual(regex.find('abc'), { value: 'a', start: 0, end: 1 });
...
export const r_regex_find_all = { test: () => {
	const regex = new RRegex('a');
...
export const r_regex_captures_length = { test: () => {
...
export const r_regex_captures_all = { test: () => {
	const regex = new RRegex('(?P<y>\\d{4})-(?P<m>\\d{2})-(?P<d>\\d{2})');
...
export const r_regex_replace = { test: () => {
	const regex = new RRegex('a');
...
export const r_regex_splitn = { test: () => {
...
export const r_regex_shortest_match = { test: () => {
	const regex = new RRegex('a');
...
export const r_regex_shortest_match_at = { test: () => {
	const regex = new RRegex('a');
...
export const regex_syntax_hir_empty = { test: () => {
	const regex = new RRegex('');
...
export const regex_syntax_hir_literal = { test: () => {
...
export const regex_syntax_hir_class = { test: () => {
...
export const regex_syntax_hir_look = { test: () => {
	const regex = new RRegex('^$');
	deepEqual(regex.syntax(), {
		'@name': 'regex_syntax::hir::Hir',
		'@type': 'struct',
...
export const regex_syntax_hir_repetition = { test: () => {
...
export const regex_syntax_hir_capture = { test: () => {
...
export const regex_syntax_empty_character_class = { test: () => {
...
export const captures_toady = { test: () => {
